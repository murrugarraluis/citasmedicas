							...
							@foreach ($appointments as $appointment)
								<tr>
									<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
										<p class="text-gray-600 whitespace-no-wrap">{{ $appointment->user->DNI }}</p>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
										<p
									...
									<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
										<p class="text-gray-600 whitespace-no-wrap">{{$appointment->hospital->name}}
										</p>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
									...
									@if ($appointment->status == 'Retrasado')
										...
										{{--												<button wire:click="renovate({{ $hospital->id }})"--}}
									...
									@elseif($appointment->status == 'Atendido')
										...
										{{--												<div class="flex">--}}
										{{--													<a wire:click="delete({{ $hospital->id }})"--}}
